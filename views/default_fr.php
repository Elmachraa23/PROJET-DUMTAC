...
<body>
 ...
 <!--Header Start-->
    <header>
        ...
        <ul class="menu">
            <li>
                <a href="?page=home/index">Acceuil</a>
            </li>    
            <li>
                <a href="?page=agency/index">Agence
                    <i class="fa fa-caret-down"></i>
                    <div class="dropdown_menu">
                        <ul>
                            <li>
                                <a href="?page=agency/strategie_branding">Stratégie et Marque</a>
                            </li>
    
                            <li>
                                <a href="?page=agency/content_factory">Contenu société</a>
                            </li>
    
                            <li>
                                <a href="?page=agency/social_media">Réseaux Social</a>
                            </li>
                        </ul>
                    </div>             
                </a>
            ...
            <li>
                <a href="?page=home/contact">Contactez</a>
            </li>            
        </ul>
        <div class="translate">
